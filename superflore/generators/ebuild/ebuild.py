...
from superflore.exceptions import UnknownBuildType, UnresolvedDependency
from superflore.utils import get_license, resolve_dep, sanitize_string, trim_string

# TODO(allenh1): is there a better way to get these?
depend_only_pkgs = ['dev-util/gperf', 'app-doc/doxygen', 'virtual/pkgconfig']
...
class Ebuild(object):
    ...
    def get_ebuild_text(self, distributor, license_text):
        ...
        self.description = sanitize_string(self.description, self.illegal_desc_chars)
